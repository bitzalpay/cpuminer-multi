 ...
 * ✓ __minotaurx__ MinotaurX (Bitzal [ZAL], Ring [RNG])
...
Download
========
 * Windows releases: https://github.com/bitzalpay/cpuminer-multi/releases
 * Git tree:   https://github.com/bitzalpay/cpuminer-multi
   * Clone with `git clone https://github.com/bitzalpay/cpuminer-multi`
